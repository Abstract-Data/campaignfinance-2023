...
class TECRecord(Base):
    ...
    filerIdent = Column(Integer, nullable=True, primary_key=True)
    ...
    payeeStreetPostalCode = Column(Integer, nullable=True)
    ...
    contributorStreetPostalCode = Column(Integer, nullable=True)
