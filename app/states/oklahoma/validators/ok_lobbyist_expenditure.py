...
class OklahomaLobbyistExpenditure(OklahomaSettings, table=True):
    ...
    expenditure_id: int = Field(
        ..., title="Expenditure ID")
    lobbyistid: int = Field(
        ..., title="Lobbyist ID")
    lobbyist_firstname: Optional[str] = Field(
        default=None, title="Lobbyist First Name")
    lobbyist_middlename: Optional[str] = Field(
        default=None, title="Lobbyist Middle Name")
    lobbyist_lastname: str = Field(
        ..., title="Lobbyist Last Name")
    lobbyist_suffix: Optional[str] = Field(
        default=None, title="Lobbyist Suffix")
    expenditure_type: str = Field(
        ..., title="Expenditure Type")
    expenditure_date: date = Field(
        ..., title="Expenditure Date")
    expenditure_cost: float = Field(
        ..., title="Expenditure Cost")
    meal_type: Optional[str] = Field(
        default=None, title="Meal Type")
    other_meal_description: Optional[str] = Field(
        default=None, title="Other Meal Description")
    explanation: Optional[str] = Field(
        default=None, title="Explanation")
    recipient_first_name: Optional[str] = Field(
        default=None, title="Recipient First Name")
    recipient_middle_name: Optional[str] = Field(
        default=None, title="Recipient Middle Name")
    recipient_last_name: Optional[str] = Field(
        default=None, title="Recipient Last Name")
    recipient_suffix: Optional[str] = Field(
        default=None, title="Recipient Suffix")
    recipient_type: Optional[str] = Field(
        default=None, title="Recipient Type")
    recipient_title: Optional[str] = Field(
        default=None, title="Recipient Title")
    recipient_agency_office: Optional[str] = Field(
        default=None, title="Recipient Agency Office")
    relationship_to_state_officer_or_employee: Optional[str] = Field(
        default=None, title="Relationship to State Officer or Employee")
    family_member_name: Optional[str] = Field(
        default=None, title="Family Member Name")
    principal_name: Optional[str] = Field(
        default=None, title="Principal Name")
    principal_percentage_cost: Optional[str] = Field(
        default=None, title="Principal Percentage Cost")
    caucus: Optional[str] = Field(
        default=None, title="Caucus")
    committee_subcommittee: Optional[str] = Field(
        default=None, title="Committee Subcommittee")
    event_location: Optional[str] = Field(
        default=None, title="Event Location")
    event_city: Optional[str] = Field(
        default=None, title="Event City")
    event_state: Optional[str] = Field(
        default=None, title="Event State", max_length=2)
    download_date: date
    file_origin: str
