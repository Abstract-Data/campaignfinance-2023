...
class UnifiedFieldLibrary:
        ...
        self.unified_fields.update(
            {
                ...
                "transaction_type": FieldDefinition(
                    ...
                    validation_rules={
                        "enum_values": ["contribution", "expenditure", "loan", "pledge"]
                    },
                ),
            }
        )
    ...
    def _initialize_state_mappings(self):
        ...
        self.state_mappings["texas"] = [
            ...
            StateFieldMapping(
                "texas", "contributorNameOrganization", "contributor_organization", 1.0
            ),
            ...
            StateFieldMapping(
                "texas", "receivedDt", "filed_date", 0.9
            ),  # Also used in contributions
            # Debt fields
            StateFieldMapping("texas", "debtInfoId", "transaction_id", 1.0),
            StateFieldMapping(
                "texas", "loanInfoId", "transaction_id", 0.9
            ),  # Debt uses loanInfoId in Texas
