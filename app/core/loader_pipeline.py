"""Canonical ORM file-loading pipeline for state campaign finance data.

Moved from ``scripts/loaders/production_loader.py`` so ``app/core`` owns
orchestration; the script module is a thin CLI wrapper.
"""
